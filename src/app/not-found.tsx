    ...
    <main className="min-h-screen bg-background text-foreground flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl w-full text-center">
        ...
        <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
          The page you&apos;re looking for seems to have taken a detour into
          the unknown. Let&apos;s get you back on track.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          ...
          <button className="px-6 py-3 border border-border rounded-md font-medium hover:bg-accent hover:text-accent-foreground transition-colors">
            Go Back
          </button>
        </div>
