...
export const metadata = {
  ...
  description: 'Explore my portfolio of web development projects. See examples of my work with React, Node.js, and other modern web technologies.',
  keywords: ['Projects', 'Portfolio', 'Web Development Projects', 'React Projects', 'Full Stack Projects', 'Mani Work'],
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: '/projects',
