...
const experiences = [
  {
    ...
    description: 'Lead developer for the PureCode VS Code extension with Copilot-like AI integration. Architecting real-time MERN stack backends and React frontends for code suggestions. Implementing advanced full-stack analytics to track user engagement.',
